...
class TOULOUSE extends StatefulWidget {
  @override
  _TOULOUSEState createState() => _TOULOUSEState();
}

class _TOULOUSEState extends State<TOULOUSE> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        body: Column(
          children: <Widget>[
            _header(context,"TOULOUSE","assets/images/toulouse.jpg",theme),
            Flexible(
              child: Container(
