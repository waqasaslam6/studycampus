...
class BORDEAUX extends StatefulWidget {
  @override
  _BORDEAUXState createState() => _BORDEAUXState();
}

class _BORDEAUXState extends State<BORDEAUX> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        body: Column(
          children: <Widget>[
            _header(context,"BORDEAUX","assets/images/bordeaux.jpeg",theme),
            Flexible(
              child: Container(
