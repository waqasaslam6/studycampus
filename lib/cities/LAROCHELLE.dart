...
class LAROCHELLE extends StatefulWidget {
  @override
  _LAROCHELLEState createState() => _LAROCHELLEState();
}

class _LAROCHELLEState extends State<LAROCHELLE> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        body: Column(
          children: <Widget>[
            _header(context,"LA ROCHELLE","assets/images/la-rochelle.jpg",theme),
            Flexible(
              child: Container(
